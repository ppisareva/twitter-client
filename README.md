...
- [DBFlow](https://guides.codepath.com/android/DBFlow-Guide)
- [android-oauth-handler]
-[GSON]
- [Glide](https://guides.codepath.com/android/Displaying-Images-with-the-Glide-Library) - Image loading and caching library for Android
- [Twiiter core]
